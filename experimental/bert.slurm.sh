...
python3 -m lib.training.run_type_classification --dataset_file='data/ellipsis.classification.challenge.train.csv' \
                                                ...
                                                --output_dir='models/ellipsis-type-bert-challenge' \
                                                --hub_model_id='ellipsis-type-bert-challenge' \
                                                --push_to_hub \
...
python3 lib/training/run_span_classification.py  --dataset_file='data/ellipsis.span.challenge.train.csv' \
                                                 ...
                                                 --hub_model_id='ellipsis-discriminative-bert-challenge' \
                                                 --push_to_hub \
                                                 --per_device_train_batch_size=64 \
                                                 --per_device_eval_batch_size=8 \
                                                 --gradient_accumulation_steps=8 \
...
python3 lib/training/run_span_classification.py  --dataset_file='data/ellipsis.span.challenge.train.csv' \
                                                 ...
                                                 --hub_model_id='ellipsis-extractive-bert-challenge' \
                                                 --push_to_hub \
                                                 --per_device_train_batch_size=64 \
                                                 --per_device_eval_batch_size=8 \
                                                 --gradient_accumulation_steps=8 \
